...
class Encodificador(Screen):
    def encodeMessage(self):
        ...
        for x, y in zip(message, binary):
            ...
            encoded = True
        encoded_message = ''.join(encoding_message)
        self.ids.elabel.text = "Tu mensaje codificado es:"
        self.ids.emessage.text = encoded_message
    ...
    def decodeMessage(self): 
        ...
        if encoded != True:
            ...
            for x, y in zip(message, binary):
                ...
                decoding_message.append(decoding)
            decoded_message = ''.join(decoding_message)
            self.ids.dlabel.text = "Tu mensaje decodificado es:"
            self.ids.dmessage.text = decoded_message
        elif encoded == True:
            message = list(message)
            def decode_encodedMessage(s,n):
...
class EncodificadorCat(Screen):
    def encodeMessage(self):
        ...
        for x, y in zip(message, binary):
            ...
            encoded = True
        encoded_message = ''.join(encoding_message)
        self.ids.elabel.text = "El teu missatge codificat és:"
        self.ids.emessage.text = encoded_message
    ...
    def decodeMessage(self): 
        ...
        if encoded != True:
            ...
            for x, y in zip(message, binary):
                ...
                decoding_message.append(decoding)
            decoded_message = ''.join(decoding_message)
            self.ids.dlabel.text = "El teu missatge decodificat és:"
            self.ids.dmessage.text = decoded_message
        elif encoded == True:
            message = list(message)
            def decode_encodedMessage(s,n):
